    ...
    <main className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      <section className="relative h-[75vh] flex items-center justify-center overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 text-center px-6 text-white">
          <h1 className="text-5xl md:text-7xl font-bold mb-4">
            Dubinsko Pranje <span className="text-blue-400">Savke</span>
          </h1>
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 italic">Naši Rezultati</h2>
          <div className="grid md:grid-cols-2 gap-8 text-center">
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-2 rounded-2xl overflow-hidden shadow-xl border-4 border-white">
              ...
              <p className="font-bold text-slate-700 flex items-center justify-center gap-2 italic text-sm tracking-widest">
                <CheckCircle size={16} className="text-blue-600" /> PRANJE SEDIŠTA
              </p>
            </div>
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-2 rounded-2xl overflow-hidden shadow-xl border-4 border-white">
              ...
              <p className="font-bold text-slate-700 flex items-center justify-center gap-2 italic text-sm tracking-widest">
                <CheckCircle size={16} className="text-blue-600" /> NAMEŠTAJ I TEPIISI
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="py-12 bg-white text-center border-t border-slate-100">
        <a href="https://www.instagram.com/bg_dubinsko_pranje" target="_blank" className="inline-flex items-center gap-2 text-blue-600 font-bold hover:scale-105 transition-transform">
